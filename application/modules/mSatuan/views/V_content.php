    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <select class="form-control select2" style="width: 100%;" id="inModalParameter" required>
                            ...
                            <option value="user_id" disabled>Id</option>
                            <option value="user_department" disabled>Department</option>
                            <option value="user_division" disabled>Division</option>
                            <option value="user_level" disabled>Level</option>
                          </select>
                          <br/>
          ...
          <!-- /.card-header -->
          <div class="card-body contentSatuan">
